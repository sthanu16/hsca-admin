            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: CustomTextFieldWeb(
                        ...
                        prefixIcon: Padding(
                          ...
                          child: Icon(_obscureText ? Icons.visibility_off : Icons.visibility,color: ColorConstants.greenColor,),
                        )
                      ),
                    ),
                  ),
                  ...
                  InkWell(
                    onTap: (){
                      locator<NavigationService>().push(const ForgetPasswordScreenRoute(

                      ));
                    },
                    child: Text(StringControl.forgotPassword,style:  GoogleFonts.lato(
