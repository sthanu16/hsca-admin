        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(StringControl.appliances1,style: AppTextStyle.styleHeading24blw700,),
              SizedBox(height: 20.h,),
              ...
              SizedBox(height: 20.h,), Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.refrigerator,style: TextStyle(),),
                    Spacer(),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.dishwasher,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.washer,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.ac,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.furnace,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
