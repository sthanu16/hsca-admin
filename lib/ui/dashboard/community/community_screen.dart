        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(StringControl.aboutCommunity,style: AppTextStyle.styleHeading24blw700,),
              SizedBox(height: 20.h,),
              ...
              SizedBox(height: 20.h,), Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.schools,style: TextStyle(),),
                    Spacer(),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.shopping,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.distance,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.distanceToGo,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
              ...
              SizedBox(height: 20.h,),Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20.w),
                    Text(StringControl.publicTransport,style: TextStyle(),),
                    Spacer(),
                    Image.asset(ImageControl.arrowOn,scale: 4),
