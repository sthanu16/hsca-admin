...
class BedroomScreen3 extends StatefulWidget {
  const BedroomScreen3({Key? key}) : super(key: key);

  @override
  State<BedroomScreen3> createState() => _BedroomScreen3State();
}

class _BedroomScreen3State extends State<BedroomScreen3> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(StringControl.bedroom13,style: AppTextStyle.styleHeading24blw700,),
              SizedBox(height: 20.h,),
